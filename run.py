...
# INSERIRE NOME FILE QUI
raw_img = io.imread('images/NOMEFILE.jpg')
...
plt.xlabel(" Espression Category ", fontsize = 16)
...
plt.xlabel('Emojis Expression', fontsize = 16)
axes.set_xticks([])
axes.set_yticks([])
plt.tight_layout()
# show emojis
...
#plt.show()
plt.savefig(os.path.join('images/results/output.png'))
plt.close()
