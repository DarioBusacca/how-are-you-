...
if opt.resume:
    ...
    best_public = checkpoint['best_public']
    best_public_epoch = checkpoint['best_public_epoch']
    best_private = checkpoint['best_private']
    best_private_epoch = checkpoint['best_private_epoch']
    start_epoch = checkpoint['best_private_epoch'] + 1
else:
